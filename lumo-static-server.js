...
// Start static server
console.log(`🌐 [LUMO] Starting static assets server on port ${PORT}`);
...
const staticServer = app.listen(PORT, '0.0.0.0', () => {
  console.log(`✅ [LUMO] Static server ready on port ${PORT}`);
